# Ground Station V10 Requirements
...
Therefore Ground Station V10 must remain compatible with the current launch-controller / power-module behavior already documented in `docs/docs_V8/launch_controller_readme.md`.
...
- Ground Station V10 must be the only side adapted as needed
...
- [ground_v10 docs README](/Users/k_pochkaev/github/flight_computers/teensy_v0/ground/ground_v10/docs/README.md)
- [ground_v10 AI context](/Users/k_pochkaev/github/flight_computers/teensy_v0/ground/ground_v10/docs/AI_CONTEXT.md)

Current ground target is `Teensy 4.0` / `teensy:avr:teensy40`. Use repo-local libraries from `.arduino-user/libraries`; do not depend on `~/Documents/Arduino/libraries`.
